# PhotoForge v1.1.1 — Official Release
...
- **Native Setup Installer (`PhotoForge-Setup-v1.1.1-x64.exe`):** Single-file standalone Windows installer embedding desktop and CLI binaries with zero external directory dependency.
